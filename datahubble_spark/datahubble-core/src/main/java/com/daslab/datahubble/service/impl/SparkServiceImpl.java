...
public class SparkServiceImpl implements SparkService {
    ...
    public JSONObject executesqlForRanges(String sql, String[] filter, ArrayList<String> recommendColumns, String tablename) {
        ...
        while (keyIterator.hasNext()) {
            ...
            int type = util.MyTypeParser(columnType);
    ...
    public JSONArray executesqlForDistributions(String sql) {
        ...
        while (keyIterator.hasNext()){
            ...
            int type = util.MyTypeParser(typeItr.next());
    ...
    @Override
    public JSONObject getSqlResult(String sql){
        // JSONArray tableData = new JSONArray();
        // long start = System.currentTimeMillis();

        sql = util.buildSql(sql);

        return spark.getSqlResult(sql);

        // System.out.println("SparkServiceImpl.getSqlResult =========== time cost: " + (System.currentTimeMillis() - start) + "ms");
        // System.out.println("SparkServiceImpl.getSqlResult =========== sql result: " + tableData);
    }
}
