...
function init_daterangepicker() {
    if ("undefined" != typeof $.fn.daterangepicker) {
        ...
        $("#reportrange span").html(moment().subtract(7, "days").format("MMMM D, YYYY") + " - " + moment().format("MMMM D, YYYY")), $("#reportrange").daterangepicker(b, a), $("#reportrange").on("show.daterangepicker", function () {
...
function init_daterangepicker_right() {
    if ("undefined" != typeof $.fn.daterangepicker) {
        ...
        $("#reportrange_right span").html(moment().subtract(7, "days").format("MMMM D, YYYY") + " - " + moment().format("MMMM D, YYYY")), $("#reportrange_right").daterangepicker(b, a), $("#reportrange_right").on("show.daterangepicker", function () {
            console.log("show event fired")
...
function init_morris_charts() {
    "undefined" != typeof Morris && (console.log("init_morris_charts"), $("#graph_bar").length && Morris.Bar({
        element: "graph_bar",
        data: [
            {device: moment().subtract(7, "days").format("MM/DD/YYYY"), geekbench: 380},
            {device: moment().subtract(6, "days").format("MM/DD/YYYY"), geekbench: 655},
            {device: moment().subtract(5, "days").format("MM/DD/YYYY"), geekbench: 275},
            {device: moment().subtract(4, "days").format("MM/DD/YYYY"), geekbench: 1571},
            {device: moment().subtract(3, "days").format("MM/DD/YYYY"), geekbench: 655},
            {device: moment().subtract(2, "days").format("MM/DD/YYYY"), geekbench: 2154},
            {device: moment().subtract(1, "days").format("MM/DD/YYYY"), geekbench: 1144},
            {device: moment().format("MM/DD/YYYY"), geekbench: 2371},
            ],
        xkey: "device",
        ykeys: ["geekbench"],
        labels: ["Geekbench"],
