...
function clickHistory(historyid) {
    $.ajax({
        type: "POST",
        url: "http://10.141.223.30:8083/api/data/gethistorybyid",
        contentType: "application/json",
        dataType: "json",
        async: false,
        data: JSON.stringify({
    ...
    if (currentStep === 0) {
        $.ajax({
            url: "http://10.141.223.30:8083/api/hive/rowcount",
            type: "POST",
            dataType: "json",
            contentType: "application/json",
            data: JSON.stringify({"tablename": tableName}),
...
//                    async: false,
    ...
    if (currentStep < 1) {
        $.ajax({
            type: "POST",
            url: "http://10.141.223.30:8083/api/data/onlinedist",
            contentType: "application/json",
            dataType: "json",
...
function getPreviousId(historyid) {
    ...
    $.ajax({
        type: "POST",
        url: "http://10.141.223.30:8083/api/data/getpreviousid",
        contentType: "application/json",
        dataType: "json",
        async: false,
        data: JSON.stringify({
